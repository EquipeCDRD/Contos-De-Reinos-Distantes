...
$(document).ready(function() {
  ...
  $("#containerPortaIndex").on("mouseenter", function() {
    $("#portaIndex").attr(
      "src",
      "resources/style/images/gif/portaExternaTavernaAberta.gif"
    );
  });
  $("#containerPortaIndex").on("mouseleave", function() {
    $("#portaIndex").attr(
      "src",
      "resources/style/images/estatico/portaExternaTavernaFechada.png"
    );
  });
        ...
        if ($("input[name=txtapelido]").val() != "") {
          if ($("input[name=pwdsenha]").val() != "") {
            if ($("input[name=pwdconfsenha]").val() != "") {
              if (
                $("input[name=pwdsenha]").val() ==
                $("input[name=pwdconfsenha]").val()
              ) {
                cadastrar();
              } else {
                alert(
