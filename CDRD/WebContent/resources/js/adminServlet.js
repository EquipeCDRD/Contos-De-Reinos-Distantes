$(document).ready(function() {
  ...
  $.ajax({
    ...
    error: function(info) {
      alert(
        "Erro ao carregar as tabelas: " + info.status + " - " + info.statusText
      );
    }
  });
  ...
  insereNotificacao = function() {
    ...
    $.ajax({
      ...
      error: function(info) {
        alert(
          "Erro ao cadastrar uma nova notificação: " +
            info.status +
            " - " +
            info.statusText
        );
  ...
  deletaNotificacao = function(id) {
    $.ajax({
      ...
      error: function(info) {
        alert(
          "Erro ao deletar notificação " + info.status + " - " + info.statusText
        );
      }
    });
  };
  ...
  alteraNotificacao = function() {
    ...
    $.ajax({
      ...
      error: function(info) {
        alert(
          "Erro ao alterar notificação " + info.status + " - " + info.statusText
        );
      }
    });
  };
  ...
  $(function buscaPontuacoes() {
    var html =
      "<table class='tabelaGeral' id='tabelaRanking'>" +
      "<!--Tabela de Ranking-->" +
      "<tr>" +
      "<th>Posição</th>" +
      "<th>Pontuação</th>" +
