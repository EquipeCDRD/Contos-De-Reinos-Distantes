...
class sceneMenuPrincipal extends Phaser.Scene {
    ...
    create ()
    {
        ...
        const ButtonB = this.add.text(280, 270, 'Jogar', {fontSize:'50px', fill: '#3333ff', fontFamily: 'pixel font'});
        ...
        const ButtonC = this.add.text(620, 270, 'Ranking', {fontSize:'50px', fill: '#3333ff', fontFamily: 'pixel font' });
